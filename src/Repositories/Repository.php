...
class Repository implements RepositoryInterface
{
    ...
    public function getWhere(array $whereFilters = [], array $whereInFilters = [], DataLimitService $dataLimit = new DataLimitService(
    ), array                       $relations = [], array $whereHasRelations = [], array $whereDoesNotHaveRelations = [], array $orderBy = [], array $joins = [], array $select = [], array $scopes = []): mixed
    {
    ...
    public function getWhereQuery(array $whereFilters = [], array $whereInFilters = [], DataLimitService $dataLimit = new DataLimitService(
    ), array                            $relations = [], array $whereHasRelations = [], array $whereDoesNotHaveRelations = [], array $orderBy = [], array $joins = [], array $select = [], array $scopes = []): Builder|\Illuminate\Database\Eloquent\Builder
    {

        $query = ($this->model)::query();
        $repositoryQueryService = new RepositoryQueryService();
        $repositoryQueryService->whereQuery(
            $query,
            $whereFilters
        );
        if (count($relations)) {
